 ...
 */
public final class SocialOAuth2AuthorizationRequestResolver implements OAuth2AuthorizationRequestResolver {
	 ...
	 * @param oauth2AuthorizationRequestEnhancerManager 认证请求增强器提供者管理器
	 */
	public SocialOAuth2AuthorizationRequestResolver(ClientRegistrationRepository clientRegistrationRepository,
														String authorizationRequestBaseUri,
														OAuth2AuthorizationRequestEnhancerProviderManager oauth2AuthorizationRequestEnhancerManager) {
		Assert.notNull(clientRegistrationRepository, "clientRegistrationRepository cannot be null");
		Assert.hasText(authorizationRequestBaseUri, "authorizationRequestBaseUri cannot be empty");
		Assert.notNull(oauth2AuthorizationRequestEnhancerManager, "oauth2AuthorizationRequestEnhancerManager cannot be null");
		this.clientRegistrationRepository = clientRegistrationRepository;
		this.authorizationRequestMatcher = new AntPathRequestMatcher(
				authorizationRequestBaseUri + "/{" + REGISTRATION_ID_URI_VARIABLE_NAME + "}");
		this.oauth2AuthorizationRequestEnhancerManager = oauth2AuthorizationRequestEnhancerManager;
	}
	...
	private OAuth2AuthorizationRequest resolve(HttpServletRequest request, String registrationId, String redirectUriAction) {
		...
		if (oauth2AuthorizationRequestEnhancerManager != null) {
			authorizationRequest = oauth2AuthorizationRequestEnhancerManager.enhance(clientRegistration, authorizationRequest);
		}
